...
<body>
    ...
    <div class="wrapper wrapper-lower">
        ...
        <p>Ext.NET features over 100 Components and 750+ Samples for use in your ASP.NET apps. Check out the <a href="http://examples.ext.net/">Examples Explorer</a> to see what's possible.</p>
        <hr>
