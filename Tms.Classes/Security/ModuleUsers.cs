...
{
    public class ModuleUsers : DataPersist
    {
        ...
        public List<DataPersist> fnSelect(Guid UserID)
        {
            ...
            try
            {
                DataCommand mCommand = db().CreateStoredProcCommand("SecModuleUsers_Select");
                ...
                {
                    ModuleUsers mClass = new ModuleUsers();
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("SecModuleUsers_Remove");
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("SecModuleUsers_Get", (Guid)Id);
                if (mDataReader.Read())
                {
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("SecModuleUsers_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("SecModuleUsers_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
        ...
        private void MapFromDataReader(ModuleUsers mClass, IDataReader mDataReader)
        {
            try
            {
            ...
            {
                throw new Exception(ex.Message + Environment.NewLine + "ModuleUsers:MapFromDataReader");
            }
        }
