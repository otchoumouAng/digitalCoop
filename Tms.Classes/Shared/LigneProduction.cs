...
{
    public class LigneProduction : DataPersist
    {
        #region "Fields"
        ...
        public LigneProduction(int myId)
        {
            this.fnGet(myId);
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("pp_LigneProduction_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public bool fnGetDefaultSite()
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("LigneProduction_DefaultSite_Get");
                if (mDataReader.Read())
                {
                    MapFromDataReader(this, mDataReader);
                }
        ...
        public List<DataPersist> fnSelect(int mStatus, int mLigneProduction = -1)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("pp_LigneProduction_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("pp_LigneProduction_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("pp_LigneProduction_Modify");
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("pp_LigneProduction_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("pp_LigneProduction_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        private static void MapFromDataReader(LigneProduction mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\n LigneProduction:MapFromDataReader");
            }
        }
        #endregion
    ...
    public partial class LigneProductionViewModel
    {
        public LigneProduction _LigneProduction { get; set; }
