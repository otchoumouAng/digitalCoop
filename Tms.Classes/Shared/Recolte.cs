...
{
    public class Recolte: DataPersist
    {
        #region "Fields"
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("Recolte_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("Recolte_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("Recolte_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("Recolte_Modify");
                ...
                db().AddInParameter(mCommande, "@Abreviation", SqlDbType.VarChar, _Abreviation);
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("Recolte_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("Recolte_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        private static void MapFromDataReader(Recolte mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
                {
                    ...
                    if (!DBNull.Value.Equals(mDataReader["Abreviation"])) mClass._Abreviation = (string)mDataReader["Abreviation"];
    ...
    public partial class RecolteViewModel
    {
