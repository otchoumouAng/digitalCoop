...
{
    public class ConditionLivraison : DataPersist
    {
        #region "Fields"
        ...
        public ConditionLivraison(int myId)
        {
            this.fnGet(myId);
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_ConditionLivraison_Activate");
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "V2_ConditionLivraison:fnActivate");
            }
            return Result;
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_ConditionLivraison_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "V2_ConditionLivraison:fnDeActivate");
            }
            return Result;
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V2_ConditionLivraison_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("V2_ConditionLivraison_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("V2_ConditionLivraison_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("V2_ConditionLivraison_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
                    db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
                }
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "V2_ConditionLivraison:fnUpdate");
        ...
        private static void MapFromDataReader(ConditionLivraison mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\nV2_ConditionLivraison:MapFromDataReader");
            }
        }
        #endregion
    }

    public partial class ConditionLivraisonViewModel
    {
        public ConditionLivraison _ConditionLivraison { get; set; }
