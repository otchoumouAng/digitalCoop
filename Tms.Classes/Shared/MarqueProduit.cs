...
{
    public class MarqueProduit : DataPersist
    {
        #region "Fields"
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("pp_MarqueProduit_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("pp_MarqueProduit_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("pp_MarqueProduit_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("pp_MarqueProduit_Modify");
                ...
                //db().AddInParameter(mCommande, "@MarqueProduitDerive", SqlDbType.VarChar, _ProduitDerive);
                //db().AddInParameter(mCommande, "@MarqueProduitDeBase", SqlDbType.VarChar, _ProduitDeBase);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "MarqueProduit:fnUpdate");

            }
            return Result;
        }

        public bool fnUpdateBonusMarqueProduit()
        {
            bool Result;
            DataCommand mCommande;
            try
            {
                mCommande = db().CreateStoredProcCommand("MarqueProduit_ModifyBonusMarqueProduit");
        ...
        public override bool fnActivate()
        {
            ...
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("pp_MarqueProduit_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("pp_MarqueProduit_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        private static void MapFromDataReader(MarqueProduit mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\n MarqueProduit:MapFromDataReader");
            }
        }
        #endregion
    ...
    public partial class MarqueProduitViewModel
    {
        public MarqueProduit _MarqueProduit { get; set; }
        public decimal _ProduitDeBaseMarqueProduit { get; set; }
