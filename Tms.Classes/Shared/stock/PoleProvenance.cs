...
{
    public class PoleProvenance : DataPersist
    {
        #region "Fields"
        ...
        #region Constructor
        public PoleProvenance()
        {

        }

        public PoleProvenance(int myId)
        {
            this.fnGet(myId);
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("PoleProvenance_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("PoleProvenance_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("PoleProvenance_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("PoleProvenance_Modify");
                ...
                db().AddInParameter(mCommande, "@Prefixe", SqlDbType.Char,2, _Prefixe);
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("PoleProvenance_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("PoleProvenance_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        private static void MapFromDataReader(PoleProvenance mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\n PoleProvenance:MapFromDataReader");
            }
        }
        #endregion
    ...
    public partial class PoleProvenanceViewModel
    {
        public PoleProvenance _PoleProvenance { get; set; }
