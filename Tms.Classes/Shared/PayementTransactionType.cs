...
{
    public class PayementTransactionType : DataPersist
    {
        #region "Fields"
        ...
        #region Constructor
        public PayementTransactionType()
        {

        }

        public PayementTransactionType(int myId)
        {
            this.fnGet(myId);
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("PayementTransactionType_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("PayementTransactionType_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("PayementTransactionType_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("PayementTransactionType_Modify");
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "PayementTransactionType:fnUpdate");
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("PayementTransactionType_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "PayementTransactionType:fnActivate");
            }
            return Result;
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("PayementTransactionType_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "PayementTransactionType:fnDeActivate");
            }
            return Result;
        }
        ...
        private static void MapFromDataReader(PayementTransactionType mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\n PayementTransactionType:MapFromDataReader");
            }
        }
        #endregion
    ...
    public partial class PayementTransactionTypeViewModel
    {
        public PayementTransactionType _PayementTransactionType { get; set; }
