...
{
    public class ProduitGamme : DataPersist
    {
        #region "Fields"
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("pp_ProduitGamme_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("pp_ProduitGamme_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("pp_ProduitGamme_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("pp_ProduitGamme_Modify");
                ...
                //db().AddInParameter(mCommande, "@ProduitGammeDerive", SqlDbType.VarChar, _ProduitDerive);
                //db().AddInParameter(mCommande, "@ProduitGammeDeBase", SqlDbType.VarChar, _ProduitDeBase);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "ProduitGamme:fnUpdate");

            }
            return Result;
        }

        public bool fnUpdateBonusProduitGamme()
        {
            bool Result;
            DataCommand mCommande;
            try
            {
                mCommande = db().CreateStoredProcCommand("ProduitGamme_ModifyBonusProduitGamme");
        ...
        public override bool fnActivate()
        {
            ...
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("pp_ProduitGamme_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("pp_ProduitGamme_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        private static void MapFromDataReader(ProduitGamme mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\n ProduitGamme:MapFromDataReader");
            }
        }
        #endregion
    ...
    public partial class ProduitGammeViewModel
    {
        public ProduitGamme _ProduitGamme { get; set; }
        public decimal _ProduitDeBaseProduitGamme { get; set; }
