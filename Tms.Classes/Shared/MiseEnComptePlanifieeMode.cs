...
{
    public class MiseEnComptePlanifieeMode : DataPersist
    {
        #region "Fields"
        ...
        #region Constructors
        public MiseEnComptePlanifieeMode()
        {

        }

        public MiseEnComptePlanifieeMode(int MyId)
        {
            this.fnGet(MyId);
        }
        #endregion
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("MiseEnComptePlanifieeMode_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("MiseEnComptePlanifieeMode_Select");
                db().AddInParameter(mCommande, "@Status", SqlDbType.SmallInt, mStatus);
                mDataReader = db().ExecuteReader(mCommande);

                while (mDataReader.Read())
                {
                    MiseEnComptePlanifieeMode mClass = new MiseEnComptePlanifieeMode();
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("MiseEnComptePlanifieeMode_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("MiseEnComptePlanifieeMode_Modify");
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "MiseEnComptePlanifieeMode:fnUpdate");
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("MiseEnComptePlanifieeMode_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "MiseEnComptePlanifieeMode:fnActivate");
            }
            return Result;
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("MiseEnComptePlanifieeMode_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "MiseEnComptePlanifieeMode:fnDeActivate");
            }
            return Result;
        }
        ...
        private static void MapFromDataReader(MiseEnComptePlanifieeMode mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
    ...
    public partial class MiseEnComptePlanifieeModeViewModel
    {
        public MiseEnComptePlanifieeMode _MiseEnComptePlanifieeMode { get; set; }
