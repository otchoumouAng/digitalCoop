...
namespace Tms.Classes.Shared
{
    ...
    //[Proxy(Read = "~/FactureValorisationType/LoadAll")]
    //[JsonReader(RootProperty = "data")]
    public class FactureValorisationType : DataPersist
    {
        #region "Fields"
        ...
        #region Constructor
        public FactureValorisationType()
        {

        }

        public FactureValorisationType(int myId)
        {
            this.fnGet(myId);
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("FactureValorisationType_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("FactureValorisationType_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("FactureValorisationType_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("FactureValorisationType_Modify");
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "FactureValorisationType:fnUpdate");
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("FactureValorisationType_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "FactureValorisationType:fnActivate");
            }
            return Result;
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("FactureValorisationType_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "FactureValorisationType:fnDeActivate");
            }
            return Result;
        }
        ...
        private static void MapFromDataReader(FactureValorisationType mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\nTms_FactureValorisationType:MapFromDataReader");
            }
        }
        #endregion
    }

    public partial class FactureValorisationTypeViewModel
    {
        public FactureValorisationType _FactureValorisationType { get; set; }
