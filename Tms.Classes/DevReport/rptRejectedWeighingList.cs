...
public class rptRejectedWeighingList : DevExpress.XtraReports.UI.XtraReport
{
    ...
    private void InitializeComponent()
    {
            ...
            this.lblWeighingTitle.Text = "List Of Weighing rejection";
