...
{
    public class PrefinancementAgence : DataPersist
    {
        #region "Fields"
        ...
        public string CouvertureAsString
        {
            get { return _Couverture != 0 ? String.Format("{0:0.00}", _Couverture).TrimStart() : "0.0"; }
        ...
        #region Constructor
        public PrefinancementAgence()
        {

        }

        public PrefinancementAgence(Guid myID)
        {
            this.fnGet(myID);
        }
        #endregion
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V3_Prefinancement_Get", (Guid)Id);
                if (mDataReader.Read())
                {
        ...
        public bool fnGetForInvoice(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V3_Prefinancement_GetForInvoice", (Guid)Id);
                if (mDataReader.Read())
                {
                    MapFromDataReader(this, mDataReader);
                }
        ...
        public bool fnGetByNumber(string Number)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V3_Prefinancement_GetByNumber", (string)Number);
                if (mDataReader.Read())
                {
                    MapFromDataReader(this, mDataReader);
                }
        ...
        {
            return fnSelect(-1, "{Tous}", /*-1, -1, */null, null, "-1");
        }

        public List<DataPersist> fnSelect(int SiteID, string Campagne,/* int ExportateurID, int TypeID,*/ DateTime? StartDate, DateTime? EndDate, string statut)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("V3_Prefinancement_Select");
        ...
        public List<DataPersist> fnSelectForInvoice(int SiteID, string Campagne,/* int ExportateurID, int TypeID,*/ DateTime? StartDate, DateTime? EndDate, string statut)
        {
            List<DataPersist> mList = new List<DataPersist>();
            IDataReader mDataReader = null;
        ...
        //    try
        //    {
        //        DataCommand mCommande = db().CreateStoredProcCommand("V2_Prefinancement_SelectForApproval"); //N'existe pas
        //        db().AddInParameter(mCommande, "@Campagne", SqlDbType.VarChar, 9, Campagne);
        //        db().AddInParameter(mCommande, "@ExportateurID", SqlDbType.Int, ExportateurID);
        //        mDataReader = db().ExecuteReader(mCommande);
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("V3_Prefinancement_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("V3_Prefinancement_Modify");
        ...
        //    try
        //    {
        //        mCommande = db().CreateStoredProcCommand("V3_Prefinancement_ModifyAndApprove");
        //        db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
        //        db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V3_Prefinancement_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            db().AddOutParameter(mCommande, "@ErrorMessage", SqlDbType.VarChar, 1000);
        ...
        {
            bool bolResult;
            DataCommand mCommande = db().CreateStoredProcCommand("V3_Prefinancement_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            db().AddOutParameter(mCommande, "@ErrorMessage", SqlDbType.VarChar, 1000);
            ...
            {
                bolResult = false;
                throw new Exception(ex.Message + "\r\n" + "V3_Prefinancement:fnDeActivate");
            }
            return bolResult;
        }
        ...
        {
            bool bolResult;
            DataCommand mCommande = db().CreateStoredProcCommand("V3_Prefinancement_Cancel");
            db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            db().AddOutParameter(mCommande, "@ErrorMessage", SqlDbType.VarChar, 1000);
        ...
        public bool fnRemovePaymentAll()
        {
            ...
            {
                bool bolResult;
                DataCommand mCommande = db().CreateStoredProcCommand("V3_Prefinancement_RemoveDisbursementAll");
                db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
                db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
                db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
                db().AddOutParameter(mCommande, "@ErrorMessage", SqlDbType.VarChar, 1000);
        ...
        {
            bool bolResult;
            DataCommand mCommande = db().CreateStoredProcCommand("V3_Prefinancement_Approve");
            db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            db().AddOutParameter(mCommande, "@ErrorMessage", SqlDbType.VarChar, 1000);
        ...
        private static void MapFromDataReader(PrefinancementAgence mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
                {
                    ...
                    if (!DBNull.Value.Equals(mDataReader["coverage"])) mClass._Couverture = (decimal)mDataReader["coverage"];
                    ...
                    if (!DBNull.Value.Equals(mDataReader["DescriptionPreFinancement"])) mClass._Description = (string)mDataReader["DescriptionPreFinancement"];
            ...
            {
                throw new Exception(ex.Message + "\nV3_Prefinancement:MapFromDataReader");
            }
        }


        private static void MapFromDataReaderLite(PrefinancementAgence mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\nV3_Prefinancement:MapFromDataReaderLite");
            }
        }
        #endregion
    }

    public partial class PrefinancementAgenceViewModel
    {
        public PrefinancementAgence _PrefinancementAgence { get; set; }
        public string _ReportType { get; set; }
        public Tms.Components.Settings.EnumsDefinition.eExecMode _ExecMode { get; set; }
        public int _SiteParDefaut { get; set; }
    }

    public partial class PrefinancementAgenceReportType
    {
