...
{
    public class PaiementCheque : DataPersist
    {
        #region "Fields"
        private Guid _ID;
        ...
        private string _ReferenceCheque;
        ...
        {
            get { return (_Banque != null && _Banque.ID != 0 ) ? String.Format("{0:#,#}", _Banque.Nom).TrimStart() : string.Empty; }
        }
        ...
        [Column(Text = "Ref. Cheque")]
        public string ReferenceCheque
        {
            get { return _ReferenceCheque; }
            set { _ReferenceCheque = value; }
        }
        ...
        public PaiementCheque(Guid myID)
        {
            this.fnGet(myID);
        }
        #endregion
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_PaiementCheque_Activate");
        ...
        {
            bool bolResult;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_PaiementCheque_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            db().AddOutParameter(mCommande, "@ErrorMessage", SqlDbType.VarChar, 1000);
            ...
            {
                bolResult = false;
                throw new Exception(ex.Message + "\r\n" + "V2_PaiementCheque:fnDeActivate");
            }
            return bolResult;
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V2_PaiementCheque_Get", (Guid)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(Guid PrefinancementID,int BanqueID, int IsDisabled)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("V2_PaiementCheque_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    mCommande = db().CreateStoredProcCommand("V2_PaiementCheque_New");
                    db().AddOutParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, 0);
                    db().AddInParameter(mCommande, "@CreationUser", SqlDbType.VarChar, _UtilisateurCreation);
                }
                else
                {
                    mCommande = db().CreateStoredProcCommand("V2_PaiementCheque_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
                ...
                db().AddInParameter(mCommande, "@RefCheque", SqlDbType.VarChar, _ReferenceCheque);
        ...
        private static void MapFromDataReader(PaiementCheque mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
                {
                    ...
                    if (!DBNull.Value.Equals(mDataReader["RefCheque"])) mClass._ReferenceCheque = (string)mDataReader["RefCheque"];
            ...
            {
                throw new Exception(ex.Message + "\nV2_PaiementCheque:MapFromDataReader");
            }
        }
    ...
    public partial class PaiementChequeViewModel
    {
        public PaiementCheque _PaiementCheque { get; set; }
