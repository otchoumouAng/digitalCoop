...
{
    public class AnalysePhysiqueAgence : DataPersist
    {
        #region "Fields"
        ...
        public AnalysePhysiqueAgence()
        {

        }

        public AnalysePhysiqueAgence(Guid myId)
        {
            this.fnGet(myId);
        }
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                ...
                db().AddInParameter(mCommande, "@CodeId", SqlDbType.UniqueIdentifier, DBNull.Value);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "AnalysePhysiqueAgence:fnUpdate");
        ...
        public override bool fnActivate()
        {
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "AnalysePhysiqueAgence:fnActivate");
            }
            return Result;
        }
        ...
        public override bool fnDeActivate()
        {
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "AnalysePhysiqueAgence:fnDeActivate");
            }
            return Result;
        }
        ...
        public bool fnApprove()
        {
            ...
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V3_AnalysePhysique_Approve");
            db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "AnalysePhysiqueAgence:fnApprove");
            }
            return Result;
        ...
        private static void MapFromDataReader(AnalysePhysiqueAgence mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
        ...
        private static void MapFromDataReaderLight(AnalysePhysiqueAgence mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
                {
                    ...
                    if (!DBNull.Value.Equals(mDataReader["Moisture"])) mClass._Humidite = (double)mDataReader["Moisture"];
                    if (!DBNull.Value.Equals(mDataReader["Moisie"])) mClass._Moisie = (double)mDataReader["Moisie"];
            ...
            {
                throw new Exception(ex.Message + "\nAnalysePhysiqueAgence:MapFromDataReaderLight");
            }
        }
        #endregion
    ...
    public partial class AnalysePhysiqueAgenceViewModel
    {
        public AnalysePhysiqueAgence _AnalysePhysiqueAgence { get; set; }
