...
namespace Tms.Classes.Business
{
    ...
    public class PrixJournalierAgence : DataPersist
    {
        #region "Fields"
        ...
        public PrixJournalierAgence()
        {

        }

        public PrixJournalierAgence(Guid myId)
        {
            this.fnGet(myId);
        }

        public PrixJournalierAgence(DateTime mDate)
        {
            this.fnSelectByDate(mDate);
        }

        public PrixJournalierAgence(int mSite)
        {
            this.fnSelectBySite(mSite);
        }
        ...
        public List<DataPersist> fnSelect(string cropyear, int siteid, DateTime? startdate, DateTime? enddate, int desactive)
        {
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    db().AddOutParameter(mCommande, "@Numero", SqlDbType.VarChar, 6);
        ...
        public override bool fnActivate()
        {
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "PrixJournalierAgence:fnActivate");
            }
            return Result;
        ...
        public override bool fnDeActivate()
        {
            ...
            {
                bolResult = false;
                throw new Exception(ex.Message + "\r\n" + "PrixJournalierAgence:fnDeActivate");
            }
            return bolResult;
        }
        ...
        public bool fnApprove()
        {
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "PrixJournalierAgence:fnApprove");
            }
            return Result;
        }

        public bool fnSelectByDate(DateTime DatePrix)
        {
            IDataReader mDataReader = null;
            try
            {
                mDataReader = db().ExecuteReader("PrixJournalierByDate_Select", DatePrix);
                if (mDataReader.Read())
                {
                    MapFromDataReader(this, mDataReader);
                }
        ...
        public bool fnSelectBySite(int site)
        {
           
            IDataReader mDataReader = null;
            try
            {
                mDataReader = db().ExecuteReader("PrixJournalierBySite_Select", site);
                if (mDataReader.Read())
                {
                    MapFromDataReader(this, mDataReader);
                }
            ...
            {
                throw new Exception(ex.Message + "\n" + this.GetType().Name + ":fnSelectBySite");
            }
            finally
            {
                if (mDataReader != null) mDataReader.Close();
        ...
        private static void MapFromDataReader(PrixJournalierAgence mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\nPrixJournalierAgence:MapFromDataReader");
            }
        }
        #endregion
    ...
    public partial class PrixJournalierAgenceViewModel
    {
        public PrixJournalierAgence _PrixJournalierAgence { get; set; }
