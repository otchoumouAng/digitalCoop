...
{
    public class MouvementStock : DataPersist
    {
        ...
        public decimal TotalSacsEntree
        {
            get
            {
                return _Sens > 0 ? _Quantite : 0;
            }
        }

        public decimal TotalSacsSortie
        {
            get
            {
                return _Sens < 0 ? _Quantite : 0;
        ...
        public decimal TotalTareSacsEntree
        {
            get
            {
                return _Sens > 0 ? _TareSacs : 0;
            }
        }

        public decimal TotalTareSacsSortie
        {
            get
            {
                return _Sens < 0 ? _TareSacs : 0;
        ...
        public decimal TotalTarePaletteEntree
        {
            get
            {
                return _Sens > 0 ? _TarePalettes : 0;
            }
        }

        public decimal TotalTarePaletteSortie
        {
            get
            {
                return _Sens < 0 ? _TarePalettes : 0;
        ...
        public decimal TotalRetentionEntree
        {
            get
            {
                return _Sens > 0 ? _Retention : 0;
            }
        }

        public decimal TotalRetentionSortie
        {
            get
            {
                return _Sens < 0 ? _Retention : 0;
        ...
        public decimal TotalPoidsNetAccepteEntree
        {
            get
            {
                return _Sens > 0 ? _PoidsNetAccepte : 0;
            }
        }

        public decimal TotalPoidsNetAccepteSortie
        {
            get
            {
                return _Sens < 0 ? _PoidsNetAccepte : 0;
        ...
        public decimal TotalPoidsNetLivreEntree
        {
            get
            {
                return _Sens > 0 ? _PoidsNetLivre : 0;
            }
        }

        public decimal TotalPoidsNetLivreSortie
        {
            get
            {
                return _Sens < 0 ? _PoidsNetLivre : 0;
        ...
        public decimal TQuantite
        {
            get
            {
                return (TotalSacsEntree - TotalSacsSortie);
            }
        }

        public decimal TStock
        {
            get
            {
        ...
        public MouvementStock(Guid myId)
        {
            this.fnGet(myId);
        }
        #endregion
        ...
        {
            return fnSelect("{Toute}", -1, -1, null, null, -2, -1, -1);
        }

        public List<DataPersist> fnSelect(string mCampagne, int MagasinID, int ExportateurID, DateTime? StartDate, DateTime? EndDate, int sens, int mouvementTypeID, int certificationID, int EmplacementID = 1, string statut = "-1", int siteID = -1)
        {
            List<DataPersist> mList = new List<DataPersist>();
            IDataReader mDataReader = null;
        ...
        public List<DataPersist> fnSelectByLot(string numLot)
        {
            List<DataPersist> mList = new List<DataPersist>();
            IDataReader mDataReader = null;
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("V2_MouvementStock_SelectByNumLot");
                //db().AddInParameter(mCommande, "@magasinID", SqlDbType.Int, MagasinID);
                db().AddInParameter(mCommande, "@NumLot", SqlDbType.VarChar, numLot);
                mDataReader = db().ExecuteReader(mCommande);
                int i = 0;
                while (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelectPending(string mCampagne, int MagasinID, int ExportateurID, int sens, int mouvementTypeID, int certificationID, int siteID = -1)
        {
            List<DataPersist> mList = new List<DataPersist>();
            IDataReader mDataReader = null;
        ...
        public List<DataPersist> fnSelectStockItem(string mCampagne, int MagasinID, int ExportateurID, DateTime? StartDate, DateTime? EndDate, int emplacementID = -1, int siteID = -1)
        {
            List<DataPersist> mList = new List<DataPersist>();
            IDataReader mDataReader = null;
        ...
        private static void MapFromDataReader(MouvementStock mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
        ...
        private static void MapFromDataReaderLite(MouvementStock mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
        ...
        private static void MapFromDataReaderStockQte(MouvementStock mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
        ...
        private static void MapFromDataReaderStockItem(MouvementStock mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
        ...
        private static void MapIdFromDataReader(MouvementStock mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
    ...
    public partial class MouvementStockViewModel
    {
        public MouvementStock _MouvementStock { get; set; }
