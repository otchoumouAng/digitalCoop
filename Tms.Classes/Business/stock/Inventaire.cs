...
{
    public class Inventaire : DataPersist
    {
        #region Fields
        private Guid _ID;
        ...
        public Inventaire(Guid myId)
        {
            this.fnGet(myId);
        }

        public Inventaire(string _Numero)
        {
            this.Numero = _Numero;
        }
        #endregion
        ...
        {
            bool bolResult;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_Inventaire_DeActivate");
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V2_Inventaire_Get", (Guid)Id);
                if (mDataReader.Read())
                {
        ...
        {
            return fnSelect(-1, -1, "{Tous}", "-1",-1);
        }

        public List<DataPersist> fnSelect(int MagasinID, int PeriodeId, string campagneID, string statut, int siteID = 1)
        {
            ...
            try
            {
                ...
                {
                    Inventaire mClass = new Inventaire();
        ...
        public bool fnUpdate(DataTransaction mTran)
        {
            ...
            try
            {
                if (this._isnew)
                {
                    mCommande = db().CreateStoredProcCommand("V2_Inventaire_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("V2_Inventaire_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
                    db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
                }                
        ...
        public bool fnApprove()
        {
            ...
            try
            {
                mCommande = db().CreateStoredProcCommand("V2_Inventaire_Approve");
                db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);                
        ...
        private static void MapFromDataReader(Inventaire mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
    ...
    public partial class InventaireViewModel
    {
        public Inventaire _Inventaire { get; set; }
