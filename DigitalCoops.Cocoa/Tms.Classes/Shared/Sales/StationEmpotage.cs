...
{
    public class StationEmpotage : DataPersist
    {
        #region "Fields"
        ...
        #region Constructor
        public StationEmpotage()
        {

        }

        public StationEmpotage(int myId)
        {
            this.fnGet(myId);
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_StationEmpotage_Activate");
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_StationEmpotage_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "V2_StationEmpotage:fnDeActivate");
            }
            return Result;
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V2_StationEmpotage_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("V2_StationEmpotage_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("V2_StationEmpotage_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("V2_StationEmpotage_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
                    db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
                }
        ...
        private static void MapFromDataReader(StationEmpotage mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\nV2_StationEmpotage:MapFromDataReader");
            }
        }
        #endregion
    }

    public partial class StationEmpotageViewModel
    {
        public StationEmpotage _StationEmpotage { get; set; }
