...
{
    public class OrganismeCertification : DataPersist
    {
        #region "Fields"
        ...
        #region Constructor
        public OrganismeCertification()
        {

        }

        public OrganismeCertification(int myId)
        {
            this.fnGet(myId);
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_OrganismeCertification_Activate");
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "V2_OrganismeCertification:fnActivate");
            }
            return Result;
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_OrganismeCertification_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "V2_OrganismeCertification:fnDeActivate");
            }
            return Result;
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V2_OrganismeCertification_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("V2_OrganismeCertification_Select");
                db().AddInParameter(mCommande, "@Status", SqlDbType.SmallInt, mStatus);
                mDataReader = db().ExecuteReader(mCommande);

                while (mDataReader.Read())
                {
                    OrganismeCertification mClass = new OrganismeCertification();
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("V2_OrganismeCertification_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("V2_OrganismeCertification_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
                    db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
                }
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "V2_OrganismeCertification:fnUpdate");
        ...
        private static void MapFromDataReader(OrganismeCertification mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\nV2_OrganismeCertification:MapFromDataReader");
            }
        }
        #endregion
    }

    public partial class OrganismeCertificationViewModel
    {
        public OrganismeCertification _OrganismeCertification { get; set; }
