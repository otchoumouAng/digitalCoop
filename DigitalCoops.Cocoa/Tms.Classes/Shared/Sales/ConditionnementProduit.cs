...
{
    public class  ConditionnementProduit : DataPersist
    {
        ...
        public  ConditionnementProduit(int myId)
        {
            this.fnGet(myId);
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("pp_Conditionnement_Activate");
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "pp_ConditionnementProduit:fnActivate");
            }
            return Result;
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("pp_Conditionnement_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "pp_ConditionnementProduit:fnDeActivate");
            }
            return Result;
        }
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("pp_Conditionnement_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("pp_Conditionnement_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("pp_Conditionnement_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("pp_Conditionnement_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
                    db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
                }
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "pp_ConditionnementProduit:fnUpdate");
        ...
        private static void MapFromDataReader( ConditionnementProduit mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
            ...
            {
                throw new Exception(ex.Message + "\npp_ConditionnementProduit:MapFromDataReader");
            }
        }
        #endregion
    }

    public partial class  ConditionnementProduitViewModel
    {
        public  ConditionnementProduit _ConditionnementProduit { get; set; }
