...
{
    public class Emplacement : DataPersist
    {
        #region "Fields"
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_Emplacement_Activate");
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("V2_Emplacement_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("V2_Emplacement_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus, int MagasinID = -1)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("V2_Emplacement_Select");
                ...
                {
                    Emplacement mClass = new Emplacement();
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("V2_Emplacement_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("V2_Emplacement_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
                    db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
                }
        ...
        private static void MapFromDataReader(Emplacement mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
                {
                    ...
                    if (!DBNull.Value.Equals(mDataReader["MagasinDesignation"])) mClass._Magasin.Designation = (string)mDataReader["MagasinDesignation"];
    ...
    public partial class EmplacementViewModel
    {
