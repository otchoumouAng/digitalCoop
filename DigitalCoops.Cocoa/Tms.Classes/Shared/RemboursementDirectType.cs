...
{
    public class RemboursementDirectType : DataPersist
    {
        #region "Fields"
        ...
        #region Constructors
        public RemboursementDirectType()
        {

        }

        public RemboursementDirectType(int MyId)
        {
            this.fnGet(MyId);
        }
        #endregion
        ...
        public override bool fnGet(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("RemboursementDirectType_Get", (int)Id);
                if (mDataReader.Read())
                {
        ...
        public List<DataPersist> fnSelect(int mStatus)
        {
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("RemboursementDirectType_Select");
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("RemboursementDirectType_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("RemboursementDirectType_Modify");
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "RemboursementDirectType:fnUpdate");
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("RemboursementDirectType_Activate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "RemboursementDirectType:fnActivate");
            }
            return Result;
        }
        ...
        {
            bool Result;
            DataCommand mCommande = db().CreateStoredProcCommand("RemboursementDirectType_DeActivate");
            db().AddInParameter(mCommande, "@ID", SqlDbType.Int, _ID);
            db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
            db().AddParameter(mCommande, "@RowVersion", SqlDbType.Timestamp, 0, _RowVersionKey, ParameterDirection.InputOutput);
            db().AddParameter(mCommande, "ReturnValue", SqlDbType.Int, 0, null, ParameterDirection.ReturnValue);
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "RemboursementDirectType:fnDeActivate");
            }
            return Result;
        }
        ...
        private static void MapFromDataReader(RemboursementDirectType mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
    ...
    public partial class RemboursementDirectTypeViewModel
    {
        public RemboursementDirectType _RemboursementDirectType { get; set; }
