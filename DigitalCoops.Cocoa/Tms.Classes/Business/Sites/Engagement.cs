...
{
    //[Proxy(Read ="~/Engagement/Select")]
    //[JsonReader(RootProperty = "data")]
    public class Engagement : DataPersist
    {
        #region "Fields"
        ...
        private ContratPeriodeType _EngagementType;
        private Site _Sites;
        ...
        public string EngagementTypeAsString
        {
            get { return _EngagementType != null ? _EngagementType.Designation : string.Empty; }
        ...
        public ContratPeriodeType EngagementType
        {
            get
            {
        ...
        public string NumeroTonnage
        {
            get { return !string.IsNullOrEmpty(_Numero) && _Tonnage != 0 ? _Numero + " ( " + BalanceAsString + "/" + TonnageAsString + " (Kg))" : string.Empty; }
        }
        ...
        public bool fnGetByFinancing(object Id)
        {
            ...
            try
            {
                mDataReader = db().ExecuteReader("Engagement_GetByFinancing", (Guid)Id);
                if (mDataReader.Read())
                {
                    MapFromDataReader(this, mDataReader);
                }
        ...
        public List<DataPersist> fnSelect(string cropyear, int fournisseur, int typecontrat, DateTime? startdate, DateTime? enddate, string statut, int SiteID, string optionID = "NO")
        {
        ...
        public override bool fnUpdate()
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("V3_Engagement_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("V3_Engagement_Modify");
                ...
                db().AddInParameter(mCommande, "@TypeID", SqlDbType.Int, _EngagementType.ID);
        ...
        public bool fnUpdate(DataTransaction mTran)
        {
            ...
            try
            {
                if (this._isnew)
                {
                    ...
                    mCommande = db().CreateStoredProcCommand("Engagement_New");
                ...
                {
                    mCommande = db().CreateStoredProcCommand("Engagement_Modify");
                    db().AddInParameter(mCommande, "@ID", SqlDbType.UniqueIdentifier, _ID);
                    db().AddInParameter(mCommande, "@ModificationUser", SqlDbType.VarChar, _UtilisateurModification);
                    if (!string.IsNullOrEmpty(_Statut))
                        db().AddInParameter(mCommande, "@Statut", SqlDbType.Char, _Statut);
                ...
                db().AddInParameter(mCommande, "@CampagneID", SqlDbType.Char, _Campagne.Designation);
                db().AddInParameter(mCommande, "@FournisseurID", SqlDbType.Int, _Fournisseur.ID);
                db().AddInParameter(mCommande, "@TypeID", SqlDbType.Int, _Sites.ID);
                db().AddInParameter(mCommande, "@DateContrat", SqlDbType.DateTime, _DateContrat);
                db().AddInParameter(mCommande, "@DateDebut", SqlDbType.DateTime, _DateDebut);
                db().AddInParameter(mCommande, "@DateEcheance", SqlDbType.DateTime, _DateEcheance);
                db().AddInParameter(mCommande, "@Tonnage", SqlDbType.Decimal, _Tonnage);
        ...
        public bool fnRegenerate()
        {
            ...
            {
                Result = false;
                throw new Exception(ex.Message + "\r\n" + "Engagement:Engagement_ReGenerate");
        ...
        public List<DataPersist> fnSelectForFinancing(int fournisseurID, DateTime? DateFin)
        {
            List<DataPersist> mList = new List<DataPersist>();
            IDataReader mDataReader = null;
            ...
            try
            {
                DataCommand mCommande = db().CreateStoredProcCommand("ContratPeriode_SelectForFinancing");
                ...
                db().AddInParameter(mCommande, "@siteID", SqlDbType.Int, -1);
                mDataReader = db().ExecuteReader(mCommande);
                ...
                while (mDataReader.Read())
                {
                    ...
                    MapFromDataReaderLiteEng(mClass, mDataReader);
                    mList.Add(mClass);
                }
                return mList;
            }
        ...
        private static void MapFromDataReader(Engagement mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
                {
                    ...
                    mClass._EngagementType = new ContratPeriodeType();
                    if (!DBNull.Value.Equals(mDataReader["TypeID"])) mClass._EngagementType.ID = (int)mDataReader["TypeID"];
                    ...
                    if (!DBNull.Value.Equals(mDataReader["TypeDesignation"])) mClass._EngagementType.Designation = (string)mDataReader["TypeDesignation"];
                    ...
                    if (!DBNull.Value.Equals(mDataReader["DateRegeneration"])) mClass.RegenerationDate = (DateTime)mDataReader["DateRegeneration"];
                    if (!DBNull.Value.Equals(mDataReader["UtilisateurRegeneration"])) mClass.UtilisateurRegeneration = (string)mDataReader["UtilisateurRegeneration"];

                }
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message + "\nEngagement:MapFromDataReader");
            }
        }

        private static void MapFromDataReaderLite(Engagement mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
        ...
        private static void MapFromDataReaderLiteEng(Engagement mClass, IDataReader mDataReader)
        {
            try
            {
                if (mDataReader != null)
                {
                    ...
                    if (!DBNull.Value.Equals(mDataReader["DateEcheance"])) mClass._DateEcheance = (DateTime)mDataReader["DateEcheance"];
                    if (!DBNull.Value.Equals(mDataReader["Coverage"])) mClass._Coverage = (decimal)mDataReader["Coverage"];
                    if (!DBNull.Value.Equals(mDataReader["tauxFinancement"])) mClass._TauxFinancement = (decimal)mDataReader["tauxFinancement"];
                }
            }
            catch (Exception ex)
            {
    ...
    public partial class EngagementViewModel
    {
        public Engagement _Engagement { get; set; }
        public int _SiteParDefaut { get; set; }
        public TypeEngagementReport _TypeEngagementReport { get; set; }
        public Parametres _Parametres { get; set; }
        public Tms.Components.Settings.EnumsDefinition.eExecMode _ExecMode { get; set; }
    }

    public partial class TypeEngagementReport
    {
