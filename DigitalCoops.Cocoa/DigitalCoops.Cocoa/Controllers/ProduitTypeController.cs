...
namespace Tms2017.MVC.Controllers
{
    public class ProduitTypeController : Controller
    {
        ...
        public ActionResult LoadProduitTypeByProduitFini(string ItemProduitFiniID)
        {
            int itemProduitFiniID = int.Parse(ItemProduitFiniID);
            List<DataPersist> mList = new ProduitType().fnSelectByProduitFini(itemProduitFiniID);
