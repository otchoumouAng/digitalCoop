...
namespace Tms2017.MVC.Controllers
{
    public class ProduitFiniController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            X.GetCmp<Hidden>("ProduitFinihiddenPermCreer").SetValue(HasAccessFunction.fnGetUserAccessStatus("{913E99BB-12C5-46A8-9072-10C94BCB984A}", UserName));
            X.GetCmp<Hidden>("ProduitFinihiddenPermModifier").SetValue(HasAccessFunction.fnGetUserAccessStatus("{12d5692f-c3c1-489b-9338-3b72538f425a}", UserName));
            X.GetCmp<Hidden>("ProduitFinihiddenPermDesactiver").SetValue(HasAccessFunction.fnGetUserAccessStatus("{A4F2936E-7FBC-4699-BB13-31081636D05D}", UserName));
            X.GetCmp<Hidden>("ProduitFinihiddenPermActiver").SetValue(HasAccessFunction.fnGetUserAccessStatus("{48AFC910-D060-40AE-BC10-CD452FF602F4}", UserName));
            X.GetCmp<Hidden>("ProduitFinihiddenPermExporterExcel").SetValue(HasAccessFunction.fnGetUserAccessStatus("{0550EEAE-D8D8-4D2A-975F-43298A0CF8E9}", UserName));
            X.GetCmp<Hidden>("ProduitFinihiddenPermOverview").SetValue(HasAccessFunction.fnGetUserAccessStatus("{0cd5f49e-8c09-465e-8ebf-90d07aab6a3f}", UserName));
