...
namespace Tms2017.MVC.Controllers
{
    ...
    public class ContratPeriodeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            X.GetCmp<Hidden>("defaultFinancingTypeID").SetValue(mParam.ContratPeriodeTypeFinancement);
            ...
            //X.GetCmp<ComboBox>("cmbTypeContrat").SetValue(mclass.ContratPeriodeType.ID);
        ...
        {           
            ...
            mclass._ContratPeriode.ContratPeriodeType = new ContratPeriodeType();
            ...
            Parametres mParam = new Parametres(0);
            ViewData["UrlContratType"] = "LoadTypeContratPeriodeWithoutFinancingType";
            mclass._ContratPeriode.Campagne.Designation = mParam.Campagne;
            mclass._ContratPeriode.ContratPeriodeType.ID = mParam.ContratPeriodeType.ID;       
            mclass._ExecMode = Tms.Components.Settings.EnumsDefinition.eExecMode.AddNew;
            ViewData["FinancingTypeID"] = mParam.ContratPeriodeTypeFinancement;

            return new Ext.Net.MVC.PartialViewResult { ViewName = "FormContratPeriode", Model = mclass, ViewData = ViewData };
        }

        public ActionResult OnEdit(string ItemSelected)
        {            

            ContratPeriode mclass = JSON.Deserialize<ContratPeriode>(ItemSelected, new JsonSerializerSettings { DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, NullValueHandling = NullValueHandling.Ignore });

            ContratPeriodeViewModel contratVM = new ContratPeriodeViewModel();
            contratVM._ContratPeriode = new ContratPeriode();

            contratVM._ContratPeriode = mclass;
            contratVM._ExecMode = Tms.Components.Settings.EnumsDefinition.eExecMode.Update;
            Parametres parametre = new Parametres(0);
            ViewData["UrlContratType"] = "LoadTypeContratPeriodeWithoutFinancingType";
            ViewData["FinancingTypeID"] = parametre.ContratPeriodeTypeFinancement;

            return new Ext.Net.MVC.PartialViewResult { ViewName = "FormContratPeriode", Model = contratVM, ViewData = ViewData };
        }
        ...
        {            
            ...
            contratVM._ContratPeriode = mclass;
            ViewData["UrlContratType"] = "LoadTypeContratPeriode";
        ...
        public ActionResult OnPrintContratStatusLivReport(string id_frs = "", string ItemPeriodStart = "", string ItemPeriodEnd = "")
        {
            ...
            try
            {
                ...
                mclass._ContratPeriode.Sites = new Site();
                mclass._TypeContratPeriodeReport = new TypeContratPeriodeReport();
                mclass._TypeContratPeriodeReport.Designation = "StatutLiv";
        ...
        public ActionResult OnPrintContratStatusLivReportFin(string id_frs = "", string ItemPeriodStart = "", string ItemPeriodEnd = "")
        {
            ...
            try
            {
                ...
                mclass._ContratPeriode.Sites = new Site();
                mclass._TypeContratPeriodeReport = new TypeContratPeriodeReport();
                mclass._TypeContratPeriodeReport.Designation = "StatutLivFin";
        ...
        {            
            ...
            return new Ext.Net.MVC.PartialViewResult { ViewName = "FormRegenenerContratPeriode", Model = contratVM, ViewData = ViewData };
        }
        ...
        public ActionResult Select(StoreRequestParameters parameters, string ItemCropYear, string ItemFournisseur, string ItemTypeContrat, string ItemPeriodStart, string ItemPeriodEnd, string ItemStatus, string ItemSite, string ItemOption)
        {
            ...
            var mListe = (new ContratPeriode()).fnSelect(CropYearID, fournisseurID, TypeContratID, startdate, enddate, status,SiteID,optionID);           
        ...
        public ActionResult SubmitRegeneration()
        {
            try
            {
                ...
                if (result)
                {
                    ...
                    X.GetCmp<Window>("FormRegenenerContratPeriode").Close();
                }
            }
            catch (Exception ex)
            {
        ...
        {           
            ...
            return JavaScript(String.Format("CloseFormPrintBalanceCP(), addTab(window.parent.Ext.getCmp('tabCenter'), 'BalanceReport{0}', '{1}/ContratPeriode/ViewBalanceReport', this, 'Contrat Periode - Balance','report')", Guid.NewGuid(), BaseUrl));
            //return this.Direct();
        }
        ...
        public ActionResult GenerateStatutLivReport()
        {
            ...
            //HttpUtility.JavaScriptStringEncode(param)
            return JavaScript(String.Format("CloseFormPrintBalanceCP(), addTab(window.parent.Ext.getCmp('tabCenter'), 'StatusReport{0}', '{1}/ContratPeriode/ViewStatusLivReport', this, 'Contrat Periode - Delivery-Balance/Contract','report')", Guid.NewGuid(), BaseUrl));
            //return this.Direct();
        }
        ...
        public ActionResult GenerateStatutLivFinReport()
        {
            ...
            //HttpUtility.JavaScriptStringEncode(param)
            return JavaScript(String.Format("CloseFormPrintBalanceCP(), addTab(window.parent.Ext.getCmp('tabCenter'), 'StatusReport{0}', '{1}/ContratPeriode/ViewStatusLivFinReport', this, 'Contrat Periode - Delivery-Balance/Contract And Financing','report')", Guid.NewGuid(), BaseUrl));
            //return this.Direct();
        }
        ...
        public ActionResult GenerateExecutionReport()
        {
            ...
            this.Direct();
            //HttpUtility.JavaScriptStringEncode(param)
            return JavaScript(String.Format("CloseFormPrintBalanceCP(), addTab(window.parent.Ext.getCmp('tabCenter'), 'BalanceReport{0}', '{1}/ContratPeriode/ViewExecutionReport', this, 'Contrat Periode - Execution','report')", Guid.NewGuid(), BaseUrl));
            //return this.Direct();
        }
        ...
        {
            ContratPeriodeStatutLivraison report = new ContratPeriodeStatutLivraison();
            report.DataSource = DevExpressReportDs.SetDataSource(report);
        ...
        {
            ContratPeriodeStatutLivraisonFinancing report = new ContratPeriodeStatutLivraisonFinancing();
            report.DataSource = DevExpressReportDs.SetDataSource(report);
        ...
        public ActionResult ShowBalanceReportPartial()
        {
            //ViewData["Report"] = ;
            ContratPeriodeBalanceReport report = new ContratPeriodeBalanceReport();
            report.DataSource = DevExpressReportDs.SetDataSource(report);
        ...
        private ContratPeriode MapFormToObject(ContratPeriode mClass)
        {
            ...
            mClass.ContratPeriodeType = new ContratPeriodeType();
            mClass.ContratPeriodeType.ID = int.Parse(GetFormValue("TypeContratID"));
            mClass.ContratPeriodeType.Designation = X.GetCmp<ComboBox>("TypeContratID").SelectedItem.Text.ToString();
        ...
        public ActionResult OnPrintForwardContractList(string cropyear, string fournisseur, string fournisseurText, string typecontract, string typecontractText, string startDate, string endDate, string statut, string statutText, string siteID, string SiteNom)
        {
            ...
            try
            {
                ...
                return JavaScript(String.Format("addTab(window.parent.Ext.getCmp('tabCenter'), 'rdm{0}', '{1}/ContratPeriode/ViewReportResult', this, 'Contrats Periode',''),App.frmCriteriaForForwardContract.doClose()", Guid.NewGuid(), BaseUrl));
            }
            catch (Exception ex)
            {
                X.MessageBox.Show(new MessageBoxConfig
        ...
        {            
            ...
            return JavaScript(String.Format("addTab(window.parent.Ext.getCmp('tabCenter'), 'ContratDetail{0}', '{1}/ContratPeriode/ViewReport?id={0}', this, 'Execution des contrats','')", IdContrat, BaseUrl));
        }

        public ActionResult ViewReport(string id)
        {
            ContratPeriodeDetailExecutionReport report = new ContratPeriodeDetailExecutionReport();
        ...
        public ActionResult PrintBonus()
        {
            ...
            contratperiode.Campagne = new Campagne();
            contratperiode.Campagne.Designation = GetFormValue("cmbDetCropYearP");

            contratperiode.Sites = new Site();
            contratperiode.Sites.ID = int.Parse(GetFormValue("CpDetcmbSiteP"));
            contratperiode.Sites.Nom = X.GetCmp<ComboBox>("CpDetcmbSiteP").SelectedItem.Text;

            contratperiode.Fournisseur = new Fournisseur();
            contratperiode.Fournisseur.ID = int.Parse(GetFormValue("cmbDetFournisseurP"));
            contratperiode.Fournisseur.Nom = X.GetCmp<ComboBox>("cmbDetFournisseurP").SelectedItem.Text;

            //contratperiode.ContratPeriodeType = new ContratPeriodeType();
            //contratperiode.ContratPeriodeType.ID = int.Parse(GetFormValue("cmbDetTypeContrat"));

            contratperiode.DateDebut = DateTime.Parse(X.GetCmp<DateField>("dtfDetStartDateP").RawText.ToString());
            contratperiode.DateEcheance = DateTime.Parse(X.GetCmp<DateField>("dtfDetEndDateP").RawText.ToString());
            contratperiode.Statut = X.GetCmp<ComboBox>("cmbDetStatusP").SelectedItem.Value.ToString();
            contratperiode.StatutText = X.GetCmp<ComboBox>("cmbDetStatusP").SelectedItem.Text;            
            ...
            //HttpUtility.JavaScriptStringEncode(param)
            return JavaScript(String.Format("CloseFormPrimeCP(), addTab(window.parent.Ext.getCmp('tabCenter'), 'ListBonus{0}', '{1}/ContratPeriode/ViewListBonus', this, 'List Of Bonus','report')", Guid.NewGuid(), BaseUrl));
            //return this.Direct();
        }
